...
var species=this.dex.species.get(_id6);
...
}else if(format==='gamma')tierSet=tierSet.slice(slices.Gamma);else
if(format==='beta')tierSet=tierSet.slice(slices.Beta);else
if(format==='alpha')tierSet=tierSet.slice(slices.Alpha);else
if(format==='ou')tierSet=[].concat(tierSet.slice(slices.Gamma),tierSet.slice(slices.OU,slices.Uber));else
...
tierSet=[].concat(tierSet.slice(slices.Uber),tierSet.slice(slices.AG,slices.Uber));
...
if(format==='doublesuranium')tierSet=tierSet.slice(slices.Uranium);else
if(format==='doublesubers')tierSet=[].concat(tierSet.slice(slices.Uranium),tierSet.slice(slices.DUber,slices.Uranium));else
...
}else if(this.formatType==='natdex'||this.dex.gen===8){
table=table['natdex'];
}else if(this.formatType==='metronome'){
table=table['metronome'];
...
moves.push(
'hiddenpowerbug','hiddenpowerdark','hiddenpowerdragon','hiddenpowerelectric','hiddenpowerfighting','hiddenpowerfire','hiddenpowerflying','hiddenpowerghost','hiddenpowergrass','hiddenpowerground','hiddenpowerice','hiddenpowerpoison','hiddenpowerpsychic','hiddenpowerrock','hiddenpowersteel','hiddenpowerwater','hiddenpowerfairy');
