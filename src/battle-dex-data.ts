...
const BattlePokemonIconIndexes: {[id: string]: number} = {
  ...
  // uranium mega sprites, courtesy of Coomesk1d#5194
  metalynxmega: 1608 + 0,
  archillesmega: 1608 + 1,
  electruxomega: 1608 + 2,
  gyaradosnuclearmega: 1608 + 3,
  arbokmega: 1608 + 4,
  arboknuclearmega: 1608 + 5,
  baariettemega: 1608 + 6,
  baariettenuclearmega: 1608 + 7,
  drilgannmega: 1608 + 8,
  whimsicottmega: 1608 + 9,
  s51amega: 1608 + 10,
  inflagetahmega: 1608 + 11,
  syrentidemega: 1608 + 12,
  dramsamamega: 1608 + 13,
  kiricornmega: 1608 + 14,
};
