...
export const BattleSound = new class {
	...
	getSound(url: string) {
      ...
      sound.src = 'https://raw.githubusercontent.com/eriedaberrie/showdown-sprites/main/play.pokemonshowdown.com/' + url;
      // sound.src = '../showdown-sprites/play.pokemonshowdown.com/' + url;
